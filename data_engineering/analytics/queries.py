"""Mzansi Rush — Module 4: Analytics Engineering.

Example queries against the warehouse (Section 5.7 / 5.8 of the report).
Run after the ETL has loaded some events:
    python3 -m data_engineering.analytics.queries
"""

from __future__ import annotations

from data_engineering.warehouse.db import get_connection
